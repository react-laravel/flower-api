...
class FlowerDataSeeder extends Seeder
{
    ...
    private static function getFlowers(): array
    {
        return [
            ...
            [
                ...
                'description' => '多种鲜花混搭，色彩丰富，送给特别的人。',
                'meaning' => '多样、惊喜、浪漫',
                'care' => '保持水质清洁，避免阳光直射，定期喷水',
                'stock' => 35,
                'featured' => false,
            ],
            [
                ...
                'description' => '10朵彩色郁金香，高贵典雅，欧式风格。',
                'meaning' => '高贵、完美、财富',
                'care' => '保持水温10-15°C，避免阳光直射，可存活1周',
                'stock' => 25,
                'featured' => false,
            ],
            [
                'name' => '多肉植物组合',
                'name_en' => 'Succulent Arrangement',
                'category' => 'plant',
                'price' => 168,
                'original_price' => null,
                'image' => 'https://images.unsplash.com/photo-1509423350716-97f9360b4e09?w=800',
                'description' => '精美多肉植物组合，适合桌面装饰，易于养护。',
                'meaning' => '坚韧、顽强、生命',
                'care' => '少浇水，喜阳但避免暴晒，疏松土壤',
                'stock' => 60,
                'featured' => false,
            ],
        ];
